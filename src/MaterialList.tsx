...
function MaterialPreview({ material }: { material: Material }) {
  ...
  return (
    ...
    >
      ...
      <div>{color}</div>
      <button
        className="absolute -top-2 -right-1 text-xs px-2 py-1 text-black bg-gray-200 rounded-full border-2 border-slate-50"
...
export function MaterialList() {
  return (
    <div className="p-4 @container">
      <div className="grid @[14rem]:grid-cols-2 @[21rem]:grid-cols-3 gap-4">
